...
class MapViewController: UIViewController {
    ...
    func requestUserLocationAuthorization(){
        ...
        func showMessage(type: MapMessageType){
            ...
            let message = type == .authorizationWarning ? "Para usar os recursos de localizacao do app, voce precisa permitir o uso na tela de ajustes" : "Nao foi possivel encontrar esta rota"
        ...
        search.start { response, error in
            if error == nil {
                ...
                for item in response.mapItems {
                    ...
                    annotation.address = Place.getFormmatedAddress(with: item.placemark)
